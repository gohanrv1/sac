                    ...
                    <div class="col-md-12">
                       <div class="content-box">
                        ...
                        <div class="content-box-wrapper">
                         <div class="example-box-wrapper">
                            <ul class="nav-responsive nav nav-tabs">
                                <li class="active"><a href="#tab1" data-toggle="tab">Registrar Usuario</a></li>
                                <li><a href="#tab2" data-toggle="tab">Listar Usuarios</a></li>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab1">
                                        ...
                                        <div class="row">       
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="usuario" class="col-md-4 text-right">Usuario:</label>
                                                    <div class="col-md-8">                                                   
                                                        <input type="email" class="form-control" id="usuario" name="usuario" placeholder="Ingrese correo del usuario" required="true">
                                                    </div>
                                                </div>
                                            </div>
                                             <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="usuario" class="col-md-4 text-right">Nombre Empresa:</label>
                                                    <div class="col-md-8">                                                   
                                                        <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Ingrese Nombre De La Empresa" required="true">
                                                    </div>
                                                </div>
                                            </div>
                                             <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="usuario" class="col-md-4 text-right">Celular:</label>
                                                    <div class="col-md-8">                                                   
                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="rol" class="col-md-2 text-right" >Tipo Rol:</label>
                                                    <div class="col-md-8">
                                                        <select name="rol" id="rol" class="selectpicker form-control" data-live-search="true" required="">
                        ...
                        <div class="tab-pane" id="tab2">
                            ...
                            <table class="table nowrap " style="" id="datatable-example">
                                <thead>
                                <tr>
                                    <th>Usuario</th>
                                    <th>Nombre</th>                                    
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/mobile-detect/1.4.4/mobile-detect.js" integrity="sha512-mKlod4zKRIIIrcTz1adxwkprNtUm1lZZL2yP+l9UEmK6mXndshkfPojjPkVOKOanqBM9b2Gc88eBjLCAgkWtHw==" crossorigin="anonymous"></script>
	...
	<script type="text/javascript" language="javascript" src="https://cdn.datatables.net/responsive/2.2.6/js/responsive.bootstrap.min.js"></script>
    ...
    $("#fusuario").submit(function(e){    
     ...
     if($("#pass").val()==$("#pass2").val()) {
         e.preventDefault();
                  ...
                  $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>index.php/dashboard/guardar/",
                    data:$("#fusuario").serialize()
                }).done(function(res){
                    
                    if(res=="1"){ alert("Usuario ya se encuentra registrado!");}
                    if(res=="2"){alert("Usuario guardado con exito!");
                        $('#fusuario')[0].reset();
                        cargar_usuarios();
                    }
...
function eliminar_usu(id){
    ...
    if (r==true) {
            $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>index.php/dashboard/eliminar/"+id                  
            }).done(function(data){
                  $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>index.php/dashboard/mostrar_users"                   
