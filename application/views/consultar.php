                    ...
                    <div class="col-md-12">
                       <div class="content-box">
                        ...
                        <div class="content-box-wrapper">
                         <div class="example-box-wrapper container">
     ...
     $("#buscar").click(function() {
       ...
       function taxista(){
           ...
           $.ajax({
                    ...
                    console.log(taxista)
                    var taxista = JSON.parse(taxista);
                    console.log(taxista)
                    if (taxista.length > 0)
                     {
                    
                    $("#des-informacion").html(" ");
                    console.log(taxista);
      for (var i = taxista.length - 1; i >= 0; i--) {
	e = i+1

 var cuerpo = "<h4 class='content-box-header bg-primary'>  Reporte #"+e+" </h4> <div class='example-box-wrapper'>	<div class='form-group row'> <label class='col-sm-2 control-label'>Nombres:</label>  <div class='col-sm-4'> 	     <input type='text' class='form-control' id='nombres' name='nombres'  value='"+taxista[i].Nombres+"' disabled required  >    	 </div>        	<label class='col-sm-2 control-label'>Apellidos:</label>  	<div class='col-sm-4'>     		<input type='text' class='form-control' id='apellidos' name='apellidos' value='"+taxista[i].Apellidos+"' disabled required>    	</div> 	</div>      	<div class='form-group row'>     		<label class='col-sm-2 control-label'>Placa:</label>        		<div class='col-sm-4'>       			<input type='text' class='form-control' id='placa' name='placa' value='"+taxista[i].Placa+"' disabled required >   		</div>   		<label class='col-sm-2 control-label'>Estado:</label>       		<div class='col-sm-4'>   			<input type='text' class='form-control' id='Estado' name='Estado' value='"+taxista[i].Estado+"'  disabled >    		</div>   	</div>           	<div class='form-group row'>         		<label class='col-sm-2 control-label'>fecha reporte:</label>       		<div class='col-sm-4'>       			<input type='date'  value='"+taxista[i].Fecha_Reporte+"'  class='form-control' id='fecha_reporte' name='fecha_reporte' disabled required >          		</div>   		<label class='col-sm-2 control-label'>Fecha cierre:</label>    		<div class='col-sm-4'>       			<input type='date' class='form-control' id='f_cierre' name='f_cierre'  value='"+taxista[i].Fecha_cierre+"' disabled >       		</div>         	</div>     	<div class='form-group row'>      		<label class='col-sm-2 control-label'>Valor del Reporte:</label>          		<div class='col-sm-4'>   			<input type='text' value='"+taxista[i].Valor_Reporte+"' class='form-control' id='Valor_Reporte' name='Valor_Reporte' disabled >    		</div>    		<label class='col-sm-2 control-label'>Reportado por:</label>      		 <div class='col-sm-4'>   		 	<input type='text' class='form-control' id='afiliado_a' name='afiliado_a' value='"+taxista[i].nombres+"'disabled >      		 </div>     		</div>       		<div class='form-group row'>    			<label class='col-sm-2 control-label'>Descripcion del Reporte:</label>  			<div class='col-sm-10'>    				<textarea class='form-control' id='d_reporte' name='d_reporte' rows='3' disabled required>"+taxista[i].Descripcion_Reporte+"</textarea>      			</div>    		</div>  	</div>"


$("#des-informacion").append(cuerpo);
    ...
    $("#des-informacion").html(" ");
                alert("El conductor no se encuentra registrado en nuestra base de datos")
                     }
