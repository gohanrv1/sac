    ...
    <div id="page-content-wrapper">
        <div>
            ...
            <div class="container">
                ...
                <form role="form" name="fusuario" id="fusuario" method="POST" action="<?php echo base_url().'index.php/login/guardarclave'; ?>" class="form-horizontal bordered-row">
                                        <div class="row">  
                                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-2 col-md-offset-6">
                                        <input type="hidden" name="tokenclave" id="tokenclave" value="<?php echo $tokenclave; ?>">
...
$(document).ready(function() {
 ...
 if($("#pass").val()==$("#pass2").val()) {
         e.preventDefault();
                  ...
                  $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>index.php/login/guardarclave/",
                    data:$("#fusuario").serialize()
                }).done(function(res){
                    
                    if(res=="1"){ alert("Contraseña cambiada con exito!");recargar();}
                    if(res=="2"){alert("error al actualizar!");
                        $('#fusuario')[0].reset();
