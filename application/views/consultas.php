                       ...
                       <div class="content-box">
                        ...
                        <div class="content-box-wrapper">
                         <div class="example-box-wrapper">
                            ...
                            <table class="table table-striped table-bordered dt-responsive nowrap" id="datatable_count">
                                <thead>
                                <tr>
                                    <th>id</th>
                                    <th>Usuario</th>                                    
...
table = $('#datatable_count').DataTable({
   ...
   buttons: [
        ...
        ajax: {
            ...
            url:"<?php echo base_url();?>index.php/dashboard/contador" ,
            type: "POST",
            dataSrc:""
        },
 
        columns: [ //parametrizacian de los datos.
